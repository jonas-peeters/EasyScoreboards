...
If you have ideas for more features please open an issue [here](https://github.com/byYottaFLOPS/EasyScoreboards/issues), just write it into the comments below or send me a PM [here](https://forums.spongepowered.org/users/yottaflops/)

## Setup
1. Place the plugin file in the mods folder of you Sponge server
2. Start the server
3. Edit the scoreboard with commands
...
[here](https://github.com/byYottaFLOPS/EasyScoreboards/issues), just write it into the comments below or send me a PM [here](https://forums.spongepowered.org/users/yottaflops/)